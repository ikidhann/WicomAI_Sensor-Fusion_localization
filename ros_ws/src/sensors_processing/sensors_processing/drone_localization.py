...
class DroneLocalization(Node):
    def __init__(self):
        ...
        self.sync_mask_sub_ = message_filters.Subscriber(self, Detection2DArray, '/drone/masks')
    ...
    def _lidar_projection(self, transformed_pcd, cv_image, cv_mask, P, img_h, img_w):
        point_count = 0
        points_in_front = 0
        points_in_frame = 0
        distance_to_drone = 0
    ...
    def localization_callback(self, pcd_msg, raw_image_msg, cam_info_msg, drone_mask_msg):
        ...
        cv_mask = self.bridge_.imgmsg_to_cv2(
            drone_mask_msg.detections[0].mask.data, 
            'mono8'
        )  
        ...
        self._lidar_projection(transformed_pcd, cv_image, cv_mask, P, IMG_H, IMG_W)
